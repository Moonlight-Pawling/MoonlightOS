...
if [[ "$choice" =~ ^[Yy]$ ]]; then
    ...
    backup_dir="Backups/build_$timestamp"
    mkdir -p "$backup_dir"
...
# Calcular cuántos sectores ocupa kernel.bin
