...
; Ya no usamos %include. Simplemente referimos a KERNEL_SECTORS,
; que será definido por el flag `-D` en la invocación de NASM.
...
.load_kernel:
    ...
    mov ah, 0x02
    mov al, KERNEL_SECTORS       ; <<< Aquí usamos la constante definida desde bash
    mov ch, 0
    mov cl, 2
    mov dh, 0
    mov dl, [boot_drive]
