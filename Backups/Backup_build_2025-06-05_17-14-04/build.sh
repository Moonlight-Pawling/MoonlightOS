...
# 2) Compilar kernel.asm en ELF64 (ya no debe referirse a KERNEL_SECTORS)
...
# 7) Compilar el bootloader, pasándole KERNEL_SECTORS por -D
...
# 9) Escribir bootloader en el primer sector
