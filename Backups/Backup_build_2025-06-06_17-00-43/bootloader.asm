...
%define KERNEL_SEGMENT  0x0000    ; Cambiado a 0x1000 en lugar de 0x0000
%define KERNEL_OFFSET   0x8000    ; Cambiado a 0x0000 en lugar de 0x8000
%define KERNEL_LBA      2         ; Probar con sector 1 de nuevo
