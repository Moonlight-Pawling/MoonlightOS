...
# 2a) [DEBUG] Compilar kernel.asm directamente a binario plano para prueba
echo "Compilando kernel.asm directamente a binario para comparación..."
nasm -f bin kernel.asm -o kernel_direct.bin

echo "Primeros bytes de kernel_direct.bin (debería comenzar con 0xB8):"
hexdump -C -n 32 kernel_direct.bin

# 2) Compilar kernel.asm como ELF64
...
echo "Primeros bytes de kernel.bin (debería ser idéntico a kernel_direct.bin):"
...
# 7) Compilar bootloader, pasándole KERNEL_SECTORS
