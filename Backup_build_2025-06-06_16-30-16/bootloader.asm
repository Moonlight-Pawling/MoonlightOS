...
.load_complete:
    ...
    ; *** NUEVO: Verificar el primer byte del kernel ***
    mov ax, KERNEL_SEGMENT
    mov es, ax
    
    ; Verificar el primer byte - debe ser 0xB8 (opcode de mov ax, imm16)
    ...
    ; *** SALTO EXPLÍCITO EN LUGAR DE JMP ***
    db 0xEA                   ; Far JMP opcode
    dw KERNEL_OFFSET           ; offset - primero en little endian
    dw KERNEL_SEGMENT          ; segmento - segundo en little endian
...
msg_loaded        db " OK. Primer byte del kernel: ", 0
msg_disk_error    db " Error leyendo disco!", 0
msg_code          db " Codigo: 0x", 0
msg_first_byte    db "0x", 0
